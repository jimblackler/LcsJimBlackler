...
static int cleverGreedyCS(const char *primary, const char *secondary,
  ...
  lengthAtPrimary[a - primary] = 0;
  lengthAtSecondary[b - secondary] = 0;
...
char *LCS_Blackler33(const char *primary, const char *secondary, size_t primaryLength, size_t secondaryLength, size_t *length) {
