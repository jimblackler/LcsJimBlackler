...
//      }
      ...
      if (appearances[appIdx] < end) {
        while (appearances[appIdx] < end && sequenceLength < longestSequence) {
...
char *LCS_Blackler13(const char *primary, const char *secondary, size_t primaryLength, size_t secondaryLength, size_t *length) {
