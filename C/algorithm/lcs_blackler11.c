...
static char *LCS(const char *primary, const char *secondary,
  ...
  maxSecondaries[longestSequence] = -1;  //<-- remove??
...
// Return the Longest Common Subsequence of the two supplied strings.
char *LCS_Blackler11(const char *primary, const char *secondary, size_t primaryLength, size_t secondaryLength, size_t *length) {
