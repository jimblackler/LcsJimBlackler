...
//printf(" %d / %d [%c] %d -> %d  @%d\n", sequenceLength, longestSequence, chr, basePosition - 1, end, secondaryIndex);
      if (secondaryIndex == -1) {
...
char *LCS_Blackler19(const char *primary, const char *secondary, size_t primaryLength, size_t secondaryLength, size_t *length) {
