...
static int reverseCleverGreedyCS(const char *primary, const char *secondary,
    size_t primaryLength, size_t secondaryLength) {
...
static char *LCS(const char *primary, const char *secondary,
  ...
  int v2 = reverseCleverGreedyCS(primary, secondary, primaryLength, secondaryLength);

  int lowerLimit = v1;
  if (v2 > lowerLimit)
    lowerLimit = v2;  size_t upperLimit = primaryLength < secondaryLength ?
...
//  printf("\n{%d / %d = %f}\n", lowerLimit, longestSequence, (float) lowerLimit / longestSequence);
...
char *LCS_Blackler3(const char *primary, const char *secondary, size_t primaryLength, size_t secondaryLength, size_t *length) {
