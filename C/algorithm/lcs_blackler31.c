...
static char *LCS(const char *primary, const char *secondary,
  ...
  int lowerLimit = maxRectangleGreedyCS(primary, secondary, primaryLength, secondaryLength);
...
char *LCS_Blackler40(const char *primary, const char *secondary, size_t primaryLength, size_t secondaryLength, size_t *length) {
