...
//}
  ...
  *lcs = longestSequence;
  ...
  for (int primaryIndex = 0; longestSequence2 < longestSequence;
    ...
    // blah2
    while (minimumSequence < longestSequence2 &&
        maxPrimaries[longestSequence - minimumSequence - 1] < primaryIndex)
      minimumSequence++;
...
char *LCS_Blackler14(const char *primary, const char *secondary, size_t primaryLength, size_t secondaryLength, size_t *length) {
