...
static int preCS(const char *primary, const char *secondary,
    size_t primaryLength, size_t secondaryLength, int* primaries,
    int* secondaries) {
  int cs = 0;
  {
    int _a = 0;
...
static char *LCS(const char *primary, const char *secondary,
  ...
  int *primaries = calloc(upperLimit + 1, sizeof(int));
  int *secondaries = calloc(upperLimit + 1, sizeof(int));
  int lowerLimit = preCS(primary, secondary, primaryLength, secondaryLength,
...
char *LCS_Blackler28(const char *primary, const char *secondary, size_t primaryLength, size_t secondaryLength, size_t *length) {
